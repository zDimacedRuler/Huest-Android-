...
/**
 * Created by AmanKumar on 4/20/2016.
 */
public class FilterHostFoodAdapter  extends FirebaseListAdapter<FoodModel> {
    public FilterHostFoodAdapter(Activity activity, Class<FoodModel> modelClass, int modelLayout, Firebase ref) {
